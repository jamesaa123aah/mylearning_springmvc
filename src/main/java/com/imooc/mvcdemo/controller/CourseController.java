...
public class CourseController {
	...
	public String doUploadFile(@RequestParam("file") MultipartFile file) throws IOException{
		...
		if(!file.isEmpty()){
			...
			FileUtils.copyInputStreamToFile(file.getInputStream(), new File("G:\\myLearning\\photo", System.currentTimeMillis()+ file.getOriginalFilename()));
		}
